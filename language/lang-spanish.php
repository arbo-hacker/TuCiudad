...
define("_TYPESECCODE","Tipea Código de Seguridad");
define("_ADDITIONALYGRP","Adicionalmente este módulo pertenece al Grupo de Usuarios");
define("_YOUHAVEPOINTS","Puntos que tienes por participar en el contenido del sitio:");
define("_MVIEWSUBUSERS","Ver: Sólo Usuarios Subscritos");
define("_MODULESSUBSCRIBER","Lo Sentimos, pero esta secció del sitio es sólo para <i>Usuarios Subscritos.</i>");
define("_SUBHERE","Puede subscribirse a nuestros servicios desde <a href=\"$subscription_url\">aquí</a>");
define("_SUBEXPIRED","Su Subscripción ha Expirado");
define("_HELLO","Hola");
define("_SUBSCRIPTIONAT","Esto es un mensaje automatico que le informa que su subscripción en");
define("_HASEXPIRED","ha expirado ahora.");
define("_HOPESERVED","Esperamos haberle servido con satisfacción...");
define("_SUBRENEW","Si quiere renovar su subscripción dirigete a:");
define("_YOUARE","Eres");
define("_SUBSCRIBER","subscriptor");
define("_OF","de");
...
define("_SBDAYS","dias");
define("_SUBEXPIREIN","Su subscripción expira en:");
define("_NOTSUB","No es un subscrito de");
define("_SUBFROM","Puede subscribirse desde");
define("_HERE","aquí");
define("_NOW","ahora!");
define("_ADMSUB","Usuario Subscrito!");
define("_ADMNOTSUB","Usario NO Subscrito");
define("_ADMSUBEXPIREIN","La Subscripción Expira en:");
define("_LASTIP","Última IP del Usuario:");
define("_BANTHIS","Banear esta IP");
