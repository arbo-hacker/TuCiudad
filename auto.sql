...
) ENGINE=MyISAM CHARSET=utf8 AUTO_INCREMENT=4 ;
...
CREATE TABLE `nuke_bbranks` (
  ...
  PRIMARY KEY  (`rank_id`)
) ENGINE=MyISAM CHARSET=utf8 AUTO_INCREMENT=3 ;
...
) ENGINE=MyISAM CHARSET=utf8 AUTO_INCREMENT=45 ;
...
) ENGINE=MyISAM CHARSET=utf8 AUTO_INCREMENT=2 ;
...
CREATE TABLE `nuke_blocks` (
  ...
  KEY `bid` (`bid`),
  KEY `title` (`title`)
) ENGINE=MyISAM CHARSET=utf8 AUTO_INCREMENT=19 ;
...
CREATE TABLE `nuke_cate` (
  ...
  PRIMARY KEY  (`Id`)
) ENGINE=MyISAM CHARSET=utf8 AUTO_INCREMENT=40 ;
...
CREATE TABLE `nuke_empresa` (
  ...
  PRIMARY KEY  (`ID`)
) ENGINE=MyISAM CHARSET=utf8 AUTO_INCREMENT=6 ;
...
CREATE TABLE `nuke_groups_points` (
  ...
  `points` int(10) NOT NULL default '0',
  KEY `id` (`id`)
) ENGINE=MyISAM CHARSET=utf8 AUTO_INCREMENT=22 ;
...
CREATE TABLE `nuke_headlines` (
  ...
  PRIMARY KEY  (`hid`),
  KEY `hid` (`hid`)
) ENGINE=MyISAM CHARSET=utf8 AUTO_INCREMENT=28 ;
...
CREATE TABLE `nuke_referer` (
  ...
  PRIMARY KEY  (`rid`),
  KEY `rid` (`rid`)
) ENGINE=MyISAM CHARSET=utf8 AUTO_INCREMENT=11 ;
...
CREATE TABLE `nuke_telefonos` (
  ...
  `IDEmpresa` int(10) unsigned NOT NULL default '0',
  PRIMARY KEY  (`ID`)
) ENGINE=MyISAM CHARSET=utf8 AUTO_INCREMENT=7 ;
