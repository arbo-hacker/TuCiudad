<!-- link rel="stylesheet" href="themes/bluetarget/forums/forums.css" type="text/css" -->
<style type="text/css">
...
td.rowpic {
		...
		background-image: url(themes/bluetarget/forums/images/barpic2.gif);
...
th	{
	...
	background-image: url(themes/bluetarget/forums/images/barpic3.gif);
}

td.cat,td.catHead,td.catSides,td.catLeft,td.catRight,td.catBottom {
			background-image: url(themes/bluetarget/forums/images/barpic1.gif);
...
@import url("themes/bluetarget/forums/formIE.css"); 
-->
</style>
  ...
  <tr> 
    <td class="row1" align="center"> 
      <table width="100%" cellspacing="0" cellpadding="0" border="0">
        <tr> 
          <td height="50"></td>
		  <td><a href="{U_INDEX}"><img src="themes/bluetarget/forums/images/logo.gif" border="0" alt="{L_INDEX}" vspace="1" /></a></td>
	    ...
	    <table cellspacing="0" cellpadding="2" border="0">
              <tr> 
                <td align="center" valign="top" nowrap><span class="mainmenu">&nbsp;<a href="{U_FAQ}" class="mainmenu"><img src="themes/bluetarget/forums/images/icon_mini_faq.gif" width="12" height="13" border="0" alt="{L_FAQ}" hspace="3" />{L_FAQ}</a></span><span class="mainmenu">&nbsp; 
                  &nbsp;<a href="{U_SEARCH}" class="mainmenu"><img src="themes/bluetarget/forums/images/icon_mini_search.gif" width="12" height="13" border="0" alt="{L_SEARCH}" hspace="3" />{L_SEARCH}</a>&nbsp; 
                  &nbsp;<a href="{U_PROFILE}" class="mainmenu"><img src="themes/bluetarget/forums/images/icon_mini_profile.gif" width="12" height="13" border="0" alt="{L_PROFILE}" hspace="3" />{L_PROFILE}</a>&nbsp;
                  &nbsp;<a href="{U_GROUP_CP}" class="mainmenu"><img src="themes/bluetarget/forums/images/icon_mini_groups.gif" width="12" height="13" border="0" alt="{L_USERGROUPS}" hspace="3" />{L_USERGROUPS}</a></span>&nbsp;
                  &nbsp;<a href="{U_LOGIN_LOGOUT}"><img src="themes/bluetarget/forums/images/icon_mini_login.gif" width="13" height="13" border="0" alt="{L_LOGIN_LOGOUT}" title="{L_LOGIN_LOGOUT}" hspace="3" align="top" />{L_LOGIN_LOGOUT}</a>&nbsp;
                </td>
              </tr>
              <tr> 
