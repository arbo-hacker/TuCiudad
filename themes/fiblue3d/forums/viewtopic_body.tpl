...
<td align="right" valign="top" nowrap="nowrap">{postrow.QUOTE_IMG}{postrow.EDIT_IMG}<a href="#top"></a>{postrow.DELETE_IMG}{postrow.IP_IMG}<img src="themes/fiblue3d/forums/images/icon_up.gif" alt="{L_BACK_TO_TOP}" width="16" height="18" title="{L_BACK_TO_TOP}" class="imgtopic" /></td>
</tr>
</table>
