...
<tr>
<td class="row1" rowspan="3"><img src="themes/fiblue3d/forums/images/whosonline.gif" alt="{L_WHO_IS_ONLINE}" width="25" height="25" class="imgfolder" title="{L_WHO_IS_ONLINE}" />
</td>
