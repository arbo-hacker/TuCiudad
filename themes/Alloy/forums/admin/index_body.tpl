...
<table width="100%" cellpadding="4" cellspacing="1" border="0" class="forumline">
  ...
  <!-- END reg_user_row -->
  <tr> 
	<td colspan="5" height="1" class="row3"><img src="../templates/Orange/images/spacer.gif" width="1" height="1" alt="."></td>
  </tr>
...
<table width="100%" cellpadding="4" cellspacing="1" border="0" class="forumline">
  <tr> 
    <th width="38%" nowrap height="25" class="thCornerL">Description</th>
    <th width="62%" height="25" class="thTop"><font color="#FFB100">-</font></th>
  </tr>
  <tr> 
    <td class="row1" nowrap width="38%"><span class="tableTitle">Template name:</span></td>
    <td class="row2" width="62%"><b>CitrusOrange</b></td>
  </tr>
  <tr> 
    <td class="row1" nowrap width="38%">Template Version:</td>
    <td class="row2" width="62%"><b>V1.0</b></td>
  </tr>
  <tr> 
    <td class="row1" nowrap width="38%">Created by:</td>
    <td class="row2" width="62%"><a href="http://crewxp.pcplayground.com/" target="_blank" class="smalllink"><b>CrewXp</b></a> 
  </tr>
   <tr> 
    <td class="row1" nowrap width="38%">Date of creation:</td>
    <td class="row2" width="62%"><b>05-07-2003</b></td>
  </tr>
  <tr>
    <th width="38%" nowrap height="25" class="thCornerL"><font color="#FFB100">-</font></th>
    <th width="62%" height="25" class="thTop"><font color="#FFB100">-</font></th>
  </tr>
</table>
<br />
