...
.forumline1	{ background-color: #FFA603; border: 2px #000000 solid; }
...
td.rowpic {
		...
		background-image: url(../templates/Orange/images/barpic2.gif);
...
th	{
	...
	background-image: url(../templates/Orange/images/barpic3.gif);
}
