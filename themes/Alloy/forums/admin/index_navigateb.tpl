...
<table width="100%" cellpadding="4" cellspacing="0" border="0" align="center">
  <tr> 
	<td align="center" ><a href="{U_FORUM_INDEX}" target="_parent"><img src="../templates/Orange/images/logo_med.gif" border="0" /></a></td>
  </tr>
  <tr> 
	<td align="center" > 
	  <table width="100%" cellpadding="4" cellspacing="1" border="0" class="forumline">
		...
		<!-- BEGIN catrow -->
		<tr> 
		  <td height="28" class="catSides1"><span class="cattitle">{catrow.ADMIN_CATEGORY}</span></td>
		</tr>
		<!-- BEGIN modulerow -->
		<tr> 
...
<table width="100%" cellpadding="4" cellspacing="1" border="0" class="forumline">
      <tr class="forumline"> 
    <th class="thHead" height="25" valign="middle"><span class="tableTitle"><font size="-3">Template created by <a href="http://www.wabisurf.net/" target="_blank" class="smalllink"><b>Wabisurf.net</b></a><br>
  </font></span>
  </tr>
  </table>
<br />
