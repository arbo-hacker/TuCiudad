...
/* Smartor (http://smartor.is-root.com/portal.php)          */
/*                                                          */
/************************************************************/
...
function themefooter() {
    ...
    print $r_file;
        ...
        $footer_message = footmsg();
            echo "</center>\n";
        echo "<center><br><font class=\"small\">:: smartDark phpbb2 style by <a href=\"http://smartor.is-root.com/portal.php\">Smartor</a> :: PHP-Nuke theme by <a href=\"http://www.nukemods.com\">www.nukemods.com</a> :: Traducido y retocado por <a href=\"http://www.nukebazar.com\">DragónNB</a> ::</font></center>";  
	echo "<br>\n";
}
