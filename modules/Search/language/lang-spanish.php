...
define("_SEARCHREVIEWS","Buscar en Análisis");
define("_REVIEWSCORE","Puntuación de este Análisis");
define("_DOWNLOADS","Descargas");
define("_SEARCHINSTORY","Buscar Todos los Comentarios en la Noticia:");
