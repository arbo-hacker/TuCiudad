...
function edituser() {
    ...
    if ($userinfo[user_avatar_type] == 1) { 
       ...
       $userinfo[user_avatar] = $board_config[avatar_gallery_path]."/".$userinfo[user_avatar]; 
	    ...
	    ."<BR><b><h5>Panel de Control para Avatares</h5></b>"
	    ."<tr><td bgcolor='$bgcolor2'>Muestra una pequeña imagen al lado de tus detalles en los posts del foro y en tu perfil. Sólo una imagen puede ser mostrada al mismo tiempo. No puede tener un ancho mayor que ".$board_config['avatar_max_width']." pixels, y un alto no mayor que ".$board_config['avatar_max_height']." pixels. El tamaño del fichero no puede ser superior a ".CoolSize($board_config['avatar_filesize']).".</td>";
	    echo "<td bgcolor='$bgcolor3' align=center>Avatar Actual<BR><IMG alt=\"\" src=\"$userinfo[user_avatar]\" width=\"40\" height=\"50\"></td></tr><BR>";
	    if ($board_config['allow_avatar_local']) {
	    echo "<form action=\"modules.php?name=Your_Account&op=avatarlist\" method=\"post\">"
	    ."<tr><td bgcolor='$bgcolor2'><b>Seleccionar Avatar desde la Galería:</b></td>"
	    ."<td bgcolor='$bgcolor3'>".$s_categories."&nbsp;<img src=\"images/right.gif\" align=middle>&nbsp;<INPUT class=button type=submit value=\"Ver Galería\"></td></tr>"
	    ."</form>";
	    } else {
	    echo "<tr><td bgcolor='$bgcolor2'><b>Seleccionar Avatar desde la Galería:</b></td>"
	    ."<td bgcolor='$bgcolor3'><b>Galería de Avatars Actualmente Desactivada</b></td></tr>";
            }
	    if ($board_config['allow_avatar_upload']) {
	    echo "<tr><td bgcolor='$bgcolor2'><b>Subir Avatar desde tu maquina:</b></td>"
	    ."<td bgcolor='$bgcolor3'><a href=\"modules.php?name=Forums&file=profile&mode=editprofile\"><b>Subir desde el Perfil del Foro</b></a></td></tr>"
	    ."<tr><td bgcolor='$bgcolor2'><b>Subir Avatar desde una URL:</b><br><SPAN class=gensmall>Introduce la URL de la localización del Avatar y haz click en el botón Enviar. El Avatar se copiará a este sitio.</</SPAN></td>"
	    ."<td bgcolor='$bgcolor3'><a href=\"modules.php?name=Forums&file=profile&mode=editprofile\"><b>Subir desde el Perfil del Foro</b></a></td></tr>";
	    } else {
	    echo "<tr><td bgcolor='$bgcolor2'><b>Subir Avatar desde tu maquina:</b></td>"
	    ."<td bgcolor='$bgcolor3'><b>Actualmente Desactivado</b></td></tr>"
	    ."<tr><td bgcolor='$bgcolor2'><b>Subir Avatar desde una URL:</b><br><SPAN class=gensmall>Introduce la URL de la localización del Avatar y haz click en el botón Enviar. El Avatar se copiará a este sitio.</SPAN></td>"
	    ."<td bgcolor='$bgcolor3'><b>Actualmente Desactivado</b></td></tr>";
	    }
	    if ($board_config['allow_avatar_remote']) {
	    echo "<form action=\"modules.php?name=Your_Account&op=avatarlinksave\" method=\"post\">"
	    ."<tr><td bgcolor='$bgcolor2'><b>Avatar desde Enlace Exterior:</b><br><SPAN class=gensmall>Introduce la URL de la localización del Avatar que deseas vincular y haz click en el botón Enviar.</SPAN></td>"
	    ."<td bgcolor='$bgcolor3'><INPUT class=post style=\"WIDTH: 200px\" size=40 name=avatar></td></tr>";
	    } else {
	    echo "<tr><td bgcolor='$bgcolor2'><b>Avatar desde Enlace Exterior:</b><br><SPAN class=gensmall>Introduce la URL de la localización del Avatar que deseas vincular y haz click en el botón Enviar.</SPAN></td>"
	    ."<td bgcolor='$bgcolor3'><b>Actualmente Desactivado</b></td></tr>";
	    }
	    echo "<tr><td bgcolor='$bgcolor3' colspan='2' align='center'>"
	    ."<INPUT class=mainoption type=submit value=Enviar>"
	    ."</form></TD></TR></TABLE>";
	CloseTable();
	include("footer.php");
    } else {
...
$avatarcatname = ereg_replace ("_", "&nbsp;", $avatarcategory);
    title("".$avatarcategory." Galería de Avatars");
    Opentable();
    nav();
    CloseTable();
    Opentable();
    echo "<center><font class=\"title\"><b>"._AVAILABLEAVATARS." en la categoría ".$avatarcatname."</b></font><br><br>"; 
  echo "<b>Haz click en un Avatar para seleccionarlo</b><br><br></center>";
    Opentable2();
  echo "<center>";
...
function avatarsave($avatar, $category) {
	...
	cookiedecode($user);
	include("header.php");
	title("Selección de Avatar Correcta!");
	OpenTable();
	nav();
	CloseTable();
	OpenTable();
	...
	echo "<center><font class=\"content\">Avatar para ".$cookie[1]." Guardado!</center></font><br><br>";
	if (ereg("(http)", $newavatar)) { echo "<center>Tu Nuevo Avatar:<br><br><IMG alt=\"\" src=\"$newavatar\"><br><br> [ <a href=\"modules.php?name=$module_name&op=edituser\">Volver al Perfil</a> | <a href=\"modules.php?name=$module_name\">Listo</a> ]<br><br></center>"; } elseif ($newavatar) { echo "<center>Tu Nuevo Avatar:<br><br><IMG alt=\"\" src=\"modules/Forums/images/avatars/$newavatar\"><br><br>[ <a href=\"modules.php?name=$module_name&op=edituser\">Volver al Perfil</a> | <a href=\"modules.php?name=$module_name\">Listo</a> ]<br><br></center>"; }
	CloseTable();
	include("footer.php");
    }
}
...
function avatarlinksave($avatar) {
	...
	echo "<center><font class=\"content\">Avatar para ".$cookie[1]." Guardado!</center></font><br><br>";
	if (ereg("(http)", $avatar)) { echo "<center>Tu Nuevo Avatar:<br><br><IMG alt=\"\" src=\"$avatar\"><br><br>[ <a href=\"modules.php?name=$module_name&op=edituser\">Volver al Perfil</a> | <a href=\"modules.php?name=$module_name\">Listo</a> ]<br><br></center>"; } elseif ($avatar) { echo "<center>Tu Nuevo Avatar:<br><br><IMG alt=\"\" src=\"modules/Forums/images/avatars/$avatar\"><br><br>[ <a href=\"modules.php?name=$module_name&op=edituser\">Volver al Perfil</a> | <a href=\"modules.php?name=$module_name\">Listo</a> ]<br><br></center>"; }
	CloseTable();
	include("footer.php");
    }
}
